import pytest
from precisely import assert_that, all_elements, is_instance

from utils import to_ast_node
from nodes import BinaryOp, Var, Function, Call, Let, Str, Int, Bool, If, Binary, Tuple, First, Second, Print, Parameter
...
class TestToAstNode:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [{"kind": Let.kind, "name": {"text": "foo"}, "value": "bar", "next": None}, Let],
            [{"kind": Str.kind, "value": "foo"}, Str],
            [{"kind": Int.kind, "value": 1}, Int],
            [{"kind": Bool.kind, "value": True}, Bool],
            [{"kind": If.kind, "condition": "foo", "then": "foo", "otherwise": "foo"}, If],
            [{"kind": Binary.kind, "lhs": "foo", "op": BinaryOp.Eq, "rhs": "foo"}, Binary],
